...
The model’s basic parameters are described in the following research articles: 
- https://biomed.bas.bg/bioautomation/2025/vol_29.1/files/29.1_03.pdf  (doi: 10.7546/ijba.2025.29.1.000988)
- https://doi.org/10.1016/j.jelekin.2016.12.006
...
- Scroll into the extracted folders, adjust the parameters as needed and run.
----------------------------------------------
